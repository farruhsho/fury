...
exports.cleanupOldCalls = exports.onUserStatusChange = exports.onMessageRead = exports.onCallEnded = exports.onIncomingCall = exports.onNewMessage = void 0;
...
exports.onNewMessage = functions.firestore
    ...
    try {
        ...
        const senderName = (sender === null || sender === void 0 ? void 0 : sender.displayName) || (sender === null || sender === void 0 ? void 0 : sender.username) || 'Someone';
        const senderAvatar = (sender === null || sender === void 0 ? void 0 : sender.avatarUrl) || '';
        ...
        const recipientIds = (chat.participantIds || []).filter((id) => id !== message.senderId);
        ...
        for (const recipientId of recipientIds) {
            ...
            if ((_a = recipient.mutedChats) === null || _a === void 0 ? void 0 : _a.includes(chatId)) {
...
exports.onIncomingCall = functions.firestore
    ...
    try {
        ...
        const callerName = (caller === null || caller === void 0 ? void 0 : caller.displayName) || (caller === null || caller === void 0 ? void 0 : caller.username) || 'Unknown';
        const callerAvatar = (caller === null || caller === void 0 ? void 0 : caller.avatarUrl) || '';
        // Get all participants except caller
        const recipientIds = (call.participantIds || []).filter((id) => id !== call.callerId);
        for (const recipientId of recipientIds) {
            const recipientDoc = await db.collection('users').doc(recipientId).get();
            const recipient = recipientDoc.data();
            if (!(recipient === null || recipient === void 0 ? void 0 : recipient.fcmToken)) {
...
exports.onCallEnded = functions.firestore
    ...
    if (before.status === 'ringing' &&
        ...
        const caller = callerDoc.data();
        const callerName = (caller === null || caller === void 0 ? void 0 : caller.displayName) || 'Unknown';
        // Get recipients who missed the call
        const recipientIds = (after.participantIds || []).filter((id) => id !== after.callerId);
        for (const recipientId of recipientIds) {
            const recipientDoc = await db.collection('users').doc(recipientId).get();
            const recipient = recipientDoc.data();
            if (!(recipient === null || recipient === void 0 ? void 0 : recipient.fcmToken))
    ...
    if (afterReadBy.length > beforeReadBy.length) {
        ...
        if (chat) {
            const allParticipantsRead = chat.participantIds
                .filter((id) => id !== after.senderId)
                .every((id) => afterReadBy.includes(id));
